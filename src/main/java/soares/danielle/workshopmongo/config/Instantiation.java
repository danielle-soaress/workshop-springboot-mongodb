package soares.danielle.workshopmongo.config;
...
import soares.danielle.workshopmongo.dto.AuthorDTO;
import soares.danielle.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String ...arg0) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("21/03/2011"), "Bom dia", "Acordei feliz :)", new AuthorDTO(maria));
		...
		CommentDTO c3 = new CommentDTO("Tenha um ótimo dia", sdf.parse("25/03/2011"), new AuthorDTO(alex));
